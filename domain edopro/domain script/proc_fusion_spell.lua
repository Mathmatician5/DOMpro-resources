...
Duel.GetFusionMaterial=(function()
	...
	return function(tp)
		...
		local g=Duel.GetMatchingGroup(Card.IsHasEffect,tp,LOCATION_EXTRA|LOCATION_DECK_MASTER_ZONE,0,nil,EFFECT_EXTRA_FUSION_MATERIAL)
		if #g>0 then
			res:Merge(g)
		end
		return res
...
function(fusfilter,matfilter,extrafil,extraop,gc2,stage2,exactcount,value,location,chkf,preselect,nosummoncheck,extratg,mincount,maxcount,sumpos)
	...
	return	function(e,tp,eg,ep,ev,re,r,rp,chk)
				location=location or (LOCATION_EXTRA|LOCATION_DECK_MASTER_ZONE)
