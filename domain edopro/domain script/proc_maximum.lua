...
function Maximum.Condition(mats)
	...
	return function(e,c,og)
		...
		local g=nil
		if og then
			g=og:Filter(Card.IsLocation,nil,LOCATION_HAND|LOCATION_DECK_MASTER_ZONE)
		else
			g=Duel.GetFieldGroup(tp,LOCATION_HAND|LOCATION_DECK_MASTER_ZONE,0)
		end
...
function Maximum.Operation(mats)
	...
	return function(e,tp,eg,ep,ev,re,r,rp,c,sg,og)
		...
		--these 3 lines are a workaround because maximum summon is confusing
		c:SetReason(REASON_SPSUMMON)
		c:SetReasonCard(c)
		c:SetReasonPlayer(tp)
